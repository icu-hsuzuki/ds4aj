...
{\centering \includegraphics[width=0.8\linewidth]{11-publicdata_files/figure-latex/nice-fig-1} 
...
\chapter{R on R Studio}\label{ronrstudio}}
...
\chapter{What is EDA?}\label{intro2eda}}
...
\hypertarget{chapters-and-sub-chapters-1}{%
\subsection{Chapters and sub-chapters}\label{chapters-and-sub-chapters-1}}
...
\hypertarget{captioned-figures-and-tables-1}{%
\subsection{Captioned figures and tables}\label{captioned-figures-and-tables-1}}
...
\subsection{Theorems and proofs}\label{theorems-and-proofs-1}}
...
\subsection{Callout blocks}\label{callout-blocks-1}}
...
\hypertarget{pages-1}{%
\subsection{404 pages}\label{pages-1}}

By default, users will be directed to a 404 page if they try to access a webpage that cannot be found. If you'd like to customize your 404 page instead of using the default, you may add either a \texttt{\_404.Rmd} or \texttt{\_404.md} file to your project root and use code and/or Markdown syntax.

\hypertarget{metadata-for-sharing-1}{%
\subsection{Metadata for sharing}\label{metadata-for-sharing-1}}
